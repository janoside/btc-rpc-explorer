module.exports = {
	...
	"routes":[
		...
		},
		{
			"category":"mempool",
			"url":"/mempool/summary",
			"desc":"Returns a summary of Widecoin Core's mempool (full output from 'getmempoolinfo')",
		...
		},
		{
			"category":"price",
			"url":"/price/marketcap",
			"desc":"Returns the market cap of Widecoin, in USD, EUR, GBP, XAU",
		},
		{
			"category":"price",
			"url":"/price/sats",
		...
		},
		{
			"category":"fun",
			"url":"/holidays/all",
			"desc":"Returns the full curated list of Widecoin Holidays."
		},
		{
			"category":"fun",
			"url":"/holidays/today",
			"desc":"Returns the Widecoin Holidays celebrated 'today' (i.e. at the time the API call is made).",
			"optionalParams": {
		...
		},
		{
			"category":"fun",
			"url":"/holidays/$DAY",
			"desc":"Returns the Widecoin Holidays celebrated on the specified day, using one of the following formats: yyyy-MM-DD, MM-DD.",
