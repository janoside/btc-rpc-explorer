...
module.exports = {
	...
	/* 13 */	{name:"Whitepaper Extractor", url:"./bitcoin-whitepaper", desc:"Extract the Briskcoin whitepaper from data embedded within the blockchain.", iconClass:"bi-file-earmark-text"},
	...
	/* 17 */	{name:"Quotes", url:"./quotes", desc:"Curated list of Briskcoin-related quotes.", iconClass:"bi-chat-quote"},
