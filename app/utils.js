...
function getcurrentsupply() {
	...
	request('https://api.widecoin.org/supply', function (error, response, body) {
	  if (!error && response.statusCode == 200) {
		 ...
		 fs.writeFile('supply.log', (getjson.result.supply).toString(), function (err) {
	...
	//----------
	try {  
		var data = fs.readFileSync('/root/explorerv3.4/supply.log', 'utf8');
...
const bip32TestnetNetwork = {
	messagePrefix: '\x18Widecoin Signed Message:\n',
	bech32: 'tb',
	bip32: {
		public: 0x043587cf,
		private: 0x04358394,
